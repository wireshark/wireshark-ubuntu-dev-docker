...
RUN apt update
RUN apt install wget -yqq
RUN wget https://raw.githubusercontent.com/wireshark/wireshark/master/tools/debian-setup.sh --install-optional --install-dep-deps --install-test-deps gcc-4.9 g++-4.9 gcc-5 g++-5 gcc-6 g++-6 gcc-7 g++-7 gcc-8 g++-8 clang-5.0 clang-6.0 clang-7
